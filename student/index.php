						...
						<div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="col-sm-8">
                                                            ...
                                                            <form method="post">
                                                                <table class="table table-responsive">
                                                                    <tr>
                                                                        <td>
                                                                             Write Something... 
                                                                             <textarea class="form-control" name="msg" rows="4" required="required"></textarea> 
                                                            <input type="submit" name="sub10" class="btn btn-sm btn-warning pull-right" value="POST NOW" /> 
                                                                        </td>
                                                                    </tr>
                                                          ...
                                                          <?php
                                                          $sel_wall=mysqli_query($dbcon,"select * from wall_post where crs='$cid' and dep='$did' and sem='$sem' and st=1 order by id  desc");
                                                          if(mysqli_num_rows($sel_wall)>0)
                                                          {
                                                              while($rw=mysqli_fetch_row($sel_wall))
                                                              {
                                                                  $sel_u=mysqli_query($dbcon,"select * from student_data where admnum='$rw[1]'");
                                                                  $r_u=mysqli_fetch_row($sel_u);
                                                                  ?>
                                                            <div class="row" style="width: 100%; border: 1px sold white; box-shadow: 0px 0px 1px black; margin-top: 10px; border-radius: 2px; padding: 5px;">
                                                            <div class="col-md-12">
                                                                <div class="col-md-2"><center><img src="stud_pic/<?php echo $r_u[15] ?>" class="img img-responsive" title="Posted By: <?php echo $r_u[6] ?>" /></center></div>
                                                                <div class="col-md-10">
                                                                    <div style="border-bottom: 1px solid #0088cc;">
                                                                        <div class="label label-primary">Posted on <?php echo date('d-M-Y',strtotime($rw[2])) ?></div>
                                                                        <?php
                                                                        if($rw[1]==$uid)
                                                                        {
                                                                            ?>
                                                                        <a href="studenthome.php?delid=<?php echo $rw[0] ?>"><span class="fa fa-trash pull-right" style="color: red;"></span></a>
                                                                        <?php
                                                                        }
                                                                        else
                                                                        {
                                                                            ?>
                                                                        <span class="fa fa-trash pull-right" style="cursor: pointer;"></span>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </div><br />
                                                                    <div><?php echo $rw[6] ?></div>                                                                    
                                                                </div>                                                                
                                                            </div>
                                                                <div class="col-lg-12 label label-sm label-primary" style="margin-top: 2px; text-align: left;">
                                                                    Posted By : <?php echo $r_u[6] ?>
                                                                </div>
                                                            </div>
                                                            <?php
                                                              }
                                                       ...
                                                       <!-- <div class="col-sm-4" style="border: 1px solid white; box-shadow: 0px 0px 2px black; padding: 10px 10px;">-->
                                                          
            <!--<div style="border: 1px solid white; box-shadow: 0px 0px 3px black; background-color: #0088CC; color: white;">-->
                <!--<h4 style="text-align: right; margin-right: 10px;"><b>MY CLASSMATES</b></h4>-->
            </div><br />
             <?php
            $sel_fr=mysqli_query($dbcon,"select * from student_data where crs='$cid' and dep='$did' and ay='$ay' and admnum!='$uid' and st>0");
            if(mysqli_num_rows($sel_fr)>0)
            {
                $i=0;
                while($rfr=mysqli_fetch_row($sel_fr))
                {
                    $i++;
                    if($i==1)
                    {
                    ...
                    ?> 
            <div class="col-lg-3">
            <!--<img src="stud_pic/<?php echo $rfr[15] ?>" class="img img-responsive" style="box-shadow: 1px 1px 3px black;" title="<?php echo $rfr[15] ?>" />-->
                <br />
            </div> 
            <?php
            if($i==4)
