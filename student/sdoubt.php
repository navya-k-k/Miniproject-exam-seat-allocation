						...
						<div class="row">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-striped">
                                                                <tr>
                                                                <td colspan="2"><center><b>CHOOSE DEPARTMENT</b></center></td>                   
                                                            </tr> 
                                                            <tr>
                                                                <td>Course</td>
                                                                <td>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        if(isset($_GET['c']))
                                                        {
                                                            $cid=$_GET['c'];
                                                            $did=$_GET['d'];
                                                            $selst=mysqli_query($dbcon,"select * from staf_data where crs='$cid' and dep='$did' and desig='3'");
                                                        ...
                                                        <div class="col-lg-2"><center>
                                                            <img src="../staff/staff_pic/<?php echo $rst[10] ?>" class="img img-responsive" style="height: 175px; border: 1px solid black; box-shadow: 0px 0px 5px black;" />
